      ...
      <div class="big-container register bottom-100 centerd">
        ...
        <div class="boxed-container">
                ...
                <div class="col l6">
                    ...
                    <form class="normal-inputs form-80 top-25 bottom-25"" role="form" method="POST" action="{{ route('password.email') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" placeholder="البريد الألكترونى" type="email" class="form-control" name="email" value="{{ old('email') }}" required>
                        ...
                        <div class="form-group">
                            <div >
                                <input type="submit" value="ارسل لينك اعادة كلمة السر">
