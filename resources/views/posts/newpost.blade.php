        ...
        <div class="row no-margin centerd">
            ...
            <div class="col l3">
                <div class="pack-box pack-white">
                    ...
                    <div class="choose-pack">
                        <input type="radio" name="pack" class="o-extra0">
                        <div>
                            اختيار
                        </div>
            ...
            <div class="col l3">
                <div class="pack-box pack-yellow">
                    ...
                    <div class="choose-pack">
                        <input type="radio" name="pack" class="o-extra1">
                        <div>
                            اختيار
                        </div>
            ...
            <div class="col l3">
                <div class="pack-box pack-red">
                    ...
                    <div class="choose-pack">
                        <input type="radio" name="pack" class="o-extra2">
                        <div>
                            اختيار
                        </div>
            ...
            <div class="col l3">
                <div class="pack-box pack-blue">
                    ...
                    <div class="choose-pack">
                        <input type="radio" name="pack" class="o-extra3">
                        <div>
                            اختيار
                        </div>
            ...
            <div class="row no-margin borderd">
                <div class="col l6">
                    <div class="top-group">
                        ...
                        <label class="checkbox blued">
                            <input type="radio" name="price"><span></span> مجانا
                        </label>
                        <label class="checkbox blued">
                    ...
                    <div>
                        الحالة : &nbsp;<label class="checkbox blued">
                            <input type="radio" name="status"><span></span> جديد
                        </label>
                        <label class="checkbox blued">
                            <input type="radio" name="status"><span></span> مستعمل
                        </label>
                    </div>
        ...
        <div class="to-back-body">
            <div class="row no-margin">
                ...
                <div class="col l6">
                    <div class="note">
                        <img src="{{ asset('images/info.jpg')}}" alt="">
                        تأكد من ادخال جميع البيانات بشكل صحيح واضافة بيانات الاتصال بشكل واضح ومفصل ذلك سوف يساعد ويسهل
                        التواصل بين عملائك
                    </div>
                </div>
                <div class="clearfix"></div>
        ...
        <div class="to-back-body">
            <div class="row no-margin">
                ...
                <div class="col l6">
                    <div class="note">
                        <img src="{{ asset('images/info.jpg')}}" alt="">
                        تأكد من اضافة عدد كافي من الصور لتوضيح تفاصيل المنتج او الخدمة ذلك يساعد المستخدم علي الاختيار
                        مما يساعد علي زيادة مبيعاتك
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
        ...
        <div class="to-back-body">
            <div class="row no-margin">
                <div class="col l6">
                    ...
                    <div class="pay-box not-payed extra1">
                        ...
                        <div class="pay-text">
                            <h3>لون مميز
                                <select>
                                    <option>7 ايام (10) ريال</option>
                                    <option>14 ايام (18) ريال</option>
                                    <option>21 ايام (25) ريال</option>
                                </select>
                            </h3>
                            <p>
                    ...
                    <div class="pay-box not-payed extra3">
                        ...
                        <div class="pay-text">
                            ...
                            <p>
                                اضف المنتج الخاص بك ضمن افضل اعلانات القسم ليظهر بشكل مميز فوق نتائج البحث داخل القسم
                            </p>
                        </div>
                        <div class="pay-select">
                            <input type="checkbox">
                ...
                <div class="col l6">
                    <div class="note">
                        <img src="{{ asset('images/info.jpg')}}" alt="">
                        ميز اعلانك باستخدام المجموعه التي تناسبك من الخصائص المميزة لعرض الاعلان كما يمكن التحكم في فترة
                        عرضها
                    </div>
                </div>
                <div class="clearfix"></div>
